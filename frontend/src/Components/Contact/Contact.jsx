  ...
  return (
    <div className="section contactPage" id="contactMe">
      ...
      <div className="contactContainer">
        <a
          href="https://www.instagram.com/himanshu___girdhar/"
          target="_blank"
          rel="noreferrer"
        >
          <div>
        ...
        <a href="https://wa.me/9896964001" target="_blank" rel="noreferrer">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
        ...
        <a
          href="https://www.youtube.com/@HimanshuGirdharMercuryClasses"
          target="_blank"
          rel="noreferrer"
        >
          <div>
